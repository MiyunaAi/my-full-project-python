...
content_frames = [login_frame,left_frame,right_frame,leftt_frame,rightt_frame, register_frame, home_frame, add_knife_frame, remove_knife_frame, knife_list_frame, checkout_frame,sell_product_frame,cart_frame,history_frame ]
...
welcome_label = ttk.Label(rightt_frame, text="ยินดีต้อนรับสู่ร้านตะดอบจอบเสียม", font=("Arial", 20))
welcome_label.pack(pady=130)  # ใช้ anchor="n" เพื่อจัดให้อยู่ด้านบนสุด

Register_title_label = ttk.Label(rightt_frame, text="Register", font=("Arial", 16))
Register_title_label.pack(pady=5)

# ฟอร์มสมัครสมาชิก
reg_username_label = ttk.Label(rightt_frame, text="Username:")
reg_username_label.pack(pady=10)
reg_username_entry = ttk.Entry(rightt_frame)
reg_username_entry.pack(pady=10)

reg_password_label = ttk.Label(rightt_frame, text="Password:")
reg_password_label.pack(pady=10)
reg_password_entry = ttk.Entry(rightt_frame, show="*")
reg_password_entry.pack(pady=10)

# เพิ่มช่องกรอก Confirm Password
reg_confirm_password_label = ttk.Label(rightt_frame, text="Confirm Password:")
reg_confirm_password_label.pack(pady=10)
reg_confirm_password_entry = ttk.Entry(rightt_frame, show="*")
