...
def show_login_window():
   ...
   # welcome_label = ttk.Label(login_frame, text="ยินดีต้อนรับสู่ร้านตะดอบจอบเสียม", font=("Arial", 16))
    ...
    login_frame.place(x=1000,y=150)
...
content_frames = [login_frame,left_frame,right_frame, register_frame, home_frame, add_knife_frame, remove_knife_frame, knife_list_frame, checkout_frame,sell_product_frame,cart_frame,history_frame ]
...
welcome_label = ttk.Label(login_frame, text="ยินดีต้อนรับสู่ร้านตะดอบจอบเสียม", font=("Arial", 20))
welcome_label.pack(pady=15)

login_title_label = ttk.Label(login_frame, text="Login", font=("Arial", 20))
