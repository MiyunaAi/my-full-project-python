...
toggle_add_button = ttk.Button(root, text="แสดง เพิ่มมีด", command=lambda: toggle_section(add_frame, toggle_add_button,bg="blue",))
...
toggle_reduce_button.pack(side=tk.TOP, padx=50)
