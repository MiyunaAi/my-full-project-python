...
def sell_product_window():
    ...
    # สร้างเฟรมย่อยสำหรับรูปภาพซ้ายและขวา
...
def show_order_bill_popup(total_price):
    ...
    background_image_path = r"C:\Users\xenos\Pictures\gif\pexels-rpnickson-2559941.jpg"  # ระบุพาธของรูปพื้นหลัง
    ...
    for name, qty in cart.items():
        ...
        price = c.fetchone()[0]
        total_item_price = qty * price
        bill_text += f"{name} x {qty} : {total_item_price} บาท\n"
    bill_text += "-" * 30 + "\n"
    bill_text += f"ราคารวมทั้งหมด: {total_price} บาท"

    # เพิ่มป้ายข้อความบิลรายการสั่งซื้อ
    bill_label = tk.Label(bill_window, text=bill_text, font=("Arial", 14), bg="white", fg="black", justify="left")
    bill_label.place(x=20, y=50)
...
content_frames = [login_frame,left_frame,right_frame,leftt_frame,rightt_frame, register_frame, home_frame, add_knife_frame, remove_knife_frame, knife_list_frame, checkout_frame,sell_product_frame,left_image_frame,right_image_frame,cart_frame,history_frame ]
...
left_image_path =r"C:\Users\xenos\Pictures\gif\bbc.jpg"  # ระบุพาธของรูปซ้าย
right_image_path =r"C:\Users\xenos\Pictures\gif\vvs.jpg"  # ระบุพาธของรูปขวา

left_image = Image.open(r"C:\Users\xenos\Pictures\gif\bbc.jpg")
left_image = left_image.resize((400, 1000), Image.LANCZOS)
left_photo = ImageTk.PhotoImage(left_image)

right_image = Image.open(r"C:\Users\xenos\Pictures\gif\aac.jpg")
right_image = right_image.resize((400, 1000), Image.LANCZOS)
