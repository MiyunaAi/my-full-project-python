...
# Entry and button to reduce stock
ttk.Label(root, text="Reduce Stock Amount:", background='#F0F8FF').pack(pady=5)
stock_reduce_entry = ttk.Entry(root, width=20)
stock_reduce_entry.pack(pady=5)

reduce_stock_button = ttk.Button(root, text="Reduce Stock", command=reduce_stock)
reduce_stock_button.pack(pady=5)

# Add new knife section
