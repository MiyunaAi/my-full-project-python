...
button_frame.pack(pady=20)  # ปรับระยะห่าง

# สร้างปุ่มหลักแถวบนสุดในกรอบ
home_button = ttk.Button(button_frame, text="หน้าหลักร้านค้า", command=show_home_window)
home_button.grid(row=0, column=0, padx=10, pady=10)

show_knives_button = ttk.Button(button_frame, text="แสดงมีดที่มีอยู่", command=show_knives_window)
show_knives_button.grid(row=0, column=1, padx=10, pady=10)

add_knife_button = ttk.Button(button_frame, text="เพิ่มมีด", command=add_knife_window)
add_knife_button.grid(row=0, column=2, padx=10, pady=10)

remove_knife_button = ttk.Button(button_frame, text="แก้ไขมีด", command=remove_knife_window)
remove_knife_button.grid(row=0, column=3, padx=10, pady=10)

checkout_button = ttk.Button(button_frame, text="ชำระเงิน", command=checkout_window)
checkout_button.grid(row=0, column=4, padx=10, pady=10)

# เพิ่มป้ายข้อความเพิ่มเติม
...
# แสดงราคารวมทั้งหมด
total_price_label = ttk.Label(checkout_frame, text="ราคารวมทั้งหมด: 0 บาท", font=("Arial", 16))
...
# แสดงหน้าหลักเมื่อเริ่มต้นโปรแกรม
show_home_window()
