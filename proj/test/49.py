...
def show_home_window(logged_in=False):
    ...
    home_image_frame.pack(side="left", fill="y")
    home_image_frame.place(y = 0)
...
kk = ttk.Style()
kk.configure("Custom.TButton", font=("Arial", 14))  # กำหนดฟอนต์ให้กับสไตล์
...
home_image_frame = ttk.Frame(home_frame)
...
register_button = ttk.Button(button_row_frame, text="Register", command=show_register_window,padding=(20, 10),style="Custom.TButton")
register_button.pack(side="left", padx=5)  # ปุ่ม Register อยู่ทางซ้าย

login_button = ttk.Button(button_row_frame, text="Login", command=login,padding=(20, 10),style="Custom.TButton")
...
login_redirect_button = ttk.Button(button_row_frame, text="Back to Login", command=show_login_window,padding=(20, 10),style="Custom.TButton")
login_redirect_button.pack(side="left", padx=10)

reg_button = ttk.Button(button_row_frame, text="Register", command=register,padding=(20, 10),style="Custom.TButton")
reg_button.pack(side="left", padx=10)



home_image_path =r"C:\Users\xenos\Pictures\gif\bgmain.png"

home_image = Image.open(r"C:\Users\xenos\Pictures\gif\bgmain.png")
home_image = home_image.resize((1550, 800), Image.LANCZOS)
home_photo = ImageTk.PhotoImage(home_image)

home_image_label = tk.Label(home_image_frame, image=home_photo)
home_image_label.image = home_photo
home_image_label.pack(pady=0)
...
add_knife_submit_button = ttk.Button(add_knife_frame, text="เพิ่มมีด", command=add_knife,padding=(20, 10),style="Custom.TButton")
...
increase_stock_button = ttk.Button(remove_knife_frame, text="เพิ่มจำนวน", command=increase_stock,padding=(20, 10),style="Custom.TButton")
increase_stock_button.pack( side = "top",padx=10,pady=10)

decrease_stock_button = ttk.Button(remove_knife_frame, text="ลดจำนวน", command=decrease_stock,padding=(20, 10),style="Custom.TButton")
decrease_stock_button.pack( side = "top",padx=10,pady=10)

delete_knife_button = ttk.Button(remove_knife_frame, text="ลบมีด", command=delete_knife,padding=(20, 10),style="Custom.TButton")
delete_knife_button.pack( side = "top",padx=10,pady=10)
...
quantity_entry = ttk.Entry(sell_product_frame,font=("Arial", 20))
quantity_entry.pack(pady=10)


add_to_cart_button = ttk.Button(sell_product_frame, text="เพิ่มลงตะกร้า", command=add_to_cart,padding=(20, 10),style="Custom.TButton")
...
increase_button = ttk.Button(cart_frame, text="เพิ่มจำนวน", command=increase_cart_item,padding=(20, 10),style="Custom.TButton")
increase_button.pack(side="top", padx=20,pady=10)

decrease_button = ttk.Button(cart_frame, text="ลดจำนวน", command=decrease_cart_item,padding=(20, 10),style="Custom.TButton")
decrease_button.pack(side="top", padx=10)

# ปุ่มยืนยันการชำระเงิน
confirm_button = ttk.Button(cart_frame, text="ยืนยันการสั่งซื้อ", command=confirm_order,padding=(20, 10),style="Custom.TButton")
